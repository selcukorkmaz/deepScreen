...
setwd('/Users/selcukkorkmaz/Documents/Studies/DeepCNNandMLP/exercise2/numericalData/')

f = list.files(paste0('/Users/selcukkorkmaz/Documents/Studies/DeepCNNandMLP/exercise2/numericalData/SDF/',aid,'/'))

for(i in 1:length(f)){
  
  system(paste0('java -jar /Users/selcukkorkmaz/Documents/Studies/DeepCNNandMLP/exercise2/numericalData/padel/PaDEL-Descriptor.jar  -threads 4 -2d -3d  -fingerprints -file /Users/selcukkorkmaz/Documents/Studies/DeepCNNandMLP/exercise2/numericalData/Result/',aid,'/',gsub(".sdf","",f[i]),'.csv  -dir /Users/selcukkorkmaz/Documents/Studies/DeepCNNandMLP/exercise2/numericalData/SDF/',aid,'/',f[i]))
...
path = paste0("/Users/selcukkorkmaz/Documents/Studies/DeepCNNandMLP/exercise2/imageData/pubchem/aid/",aid,"_datatable_all.csv")
...
data = read.csv(paste0("~/Documents/Studies/DeepCNNandMLP/exercise2/numericalData/Result/",aid,"/",aid,"_1.csv"), header = T)

f = list.files(paste0("~/Documents/Studies/DeepCNNandMLP/exercise2/numericalData/Result/",aid,"/"))

for(i in 1:length(f)){
  
  data2 = read.csv(paste0("~/Documents/Studies/DeepCNNandMLP/exercise2/numericalData/Result/",aid,"/",aid,"_",i,'.csv'), header = T)
  data = data
  if(nrow(data2)>0){
...
# dataset6[1:4,1:4]
# 
# write.table(dataset6, paste0("/Users/selcukkorkmaz/Documents/Studies/DeepCNNandMLP/numericalData/dataset/",aid,"/",aid,"_data.txt"), quote = F, row.names = F, sep = "\t")
# 
# # data.table::fread(paste0("/Users/selcukkorkmaz/Documents/Studies/DeepCNNandMLP/numericalData/dataset/",aid,"/",aid,"_data.txt"))
