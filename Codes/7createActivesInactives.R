setwd("/home/vmplatin/deepDrug/deepScreen/imageData/pubchem/")

smiles = read.table("aid/AID_485314_smiles.txt", header = T, sep = "\t")
head(smiles)
dim(smiles)
colnames(smiles) = c("PUBCHEM_CID","SMILES")

aid = read.csv("aid/AID_485314_datatable_all.csv")
head(aid)
